  ...
  return (
    <SidebarMenu>
      {projects.length === 0 || !activeProject ? (
        <SidebarMenuItem>
          <Link
            className="flex size-full items-center justify-center rounded-lg border-2 bg-accent py-2 text-center text-sm font-bold text-accent-foreground transition-colors hover:bg-primary hover:text-primary-foreground"
